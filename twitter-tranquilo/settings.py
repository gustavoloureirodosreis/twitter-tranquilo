"""
Django settings for twitter-tranquilo project.
...
ROOT_URLCONF = 'twitter-tranquilo.urls'
...
WSGI_APPLICATION = 'twitter-tranquilo.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './twitter-tranquilo.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
